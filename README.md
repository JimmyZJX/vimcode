...
- Current validation:
  ...
  - `npm test -- --runInBand` passes with 465 enabled tests.
  - The disabled-fixture backlog is fully triaged: every `// DISABLED:` header now
    ...
    intentional divergence) instead of "not triaged yet".
