...
- Current validation:
  ...
  - `npm test -- --runInBand` passes with 367 enabled tests.

Implemented first-slice behavior:

- normal/insert mode transitions, including insert-mode `ctrl-y` / `ctrl-e` copying from adjacent lines
