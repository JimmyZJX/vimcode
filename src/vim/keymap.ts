...
const finiteBindings = bindingMap([
  ...
  sharedBinding("pagedown", page({ direction: "down", halfPage: false })),
  sharedBinding("ctrl-b", page({ direction: "up", halfPage: false })),
  sharedBinding("pageup", page({ direction: "up", halfPage: false })),
  ...
  sharedBinding("ctrl-y", scrollLines("up")),
  sharedBinding("ctrl-e", scrollLines("down")),
  ...
  sharedBinding("z z", revealCurrentLine("center")),
  sharedBinding("z t", revealCurrentLine("top")),
  sharedBinding("z b", revealCurrentLine("bottom")),
